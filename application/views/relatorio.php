...
if($veiculo==0){
	...
	$sql = "select * from registro where situacao='FF' and cast( horarioentrada as date )BETWEEN '$datainicio' and '$datafim' order by 1";
	}
	else{
  $sql = "select * from registro where situacao='FF' and cast( horarioentrada as date )BETWEEN '$datainicio' and '$datafim' and veiculo='$veiculo' order by 1";
  }
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <center>
                        <h3>
                        Relatório de Registros por Placa
                            </h3>
                            </center>
                        </div>
