...
<section class="content">
  ...
  <div class="row clearfix">
          <form name="formulario" action="<?php echo site_url("cadastros/atualizaregistro")?>" method="POST">
            <div >
               <div class="default-header-blue">
                <center><h4 class="default-size-header">Registros Finalizados no Sistema</h4></center>
              ...
              <div class="default-padding-inputs">
                <div class="col-md-4">
                                    <div class="form-group">
                                        <div>
                                        <label>Placa</label>
                                        <select class="form-control show-tick" data-live-search="true" name="placa" id="placa" disabled>
                                        <option></option>
                                       <?php
                                 ...
                                 <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <label><center>Condutor</center> </label>
                                           <select class="form-control show-tick" data-live-search="true" name="condutor" id="condutor" disabled >
                                        <option></option>
                                       <?php
       ...
       <center class="eng-buttons-modal">
         ...
         <a href="<?php echo site_url("registros/abrirregistro?codigo=$codigo")?>">
          <button type="button" class="default-red-btn">Abrir Registro</button>
        </a>
      </center> 
